...
namespace SurvivalGame
{
    class EntityTracker
    {
        ...
        public static List<Entity> Entities { get => Globals.Rooms[Globals.activeRoomCoords].Entities; }
        ...
        public static void UpdateEntities(GameTime gameTime)
        {
            ...
            {
                Globals.Rooms[Globals.activeRoomCoords].Entities.Remove(deadEntity);
            }
            DeadEntities.Clear();
        }
    }
